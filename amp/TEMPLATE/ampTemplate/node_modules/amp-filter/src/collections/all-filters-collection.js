...
module.exports = Backbone.Collection.extend({
  ...
  load: function(reportType) {
    ...
    if(!this._loaded){
      ...
      if (reportType === 'P') {
      	this.url = '/rest/nifilters?report-type=P';
      }
  ...
  model: function(attrs, options) {
    ...
    switch (attrs.id) {
      case Constants.FILTER_ID_PROGRAM:
      case Constants.FILTER_ID_SECTOR:
      case Constants.FILTER_ID_ORGS:
      case Constants.FILTER_ID_LOCATION:
 ...
 _getGroup: function(definition, attrs) {
	  ...
	  if (attrs.id === Constants.FILTER_ID_ORGS && definition.name != Constants.FILTER_NAME_DONOR) {
		  group = Constants.FILTER_GROUP_ROLE;
	  }
	  
	  if (attrs.id === Constants.FILTER_ID_SECTOR) {
		  group = Constants.FILTER_GROUP_SECTOR;
	  }
	  
	  if (attrs.id === Constants.FILTER_ID_PROGRAM) {
		  group = Constants.FILTER_GROUP_PROGRAM;
	  }	 
